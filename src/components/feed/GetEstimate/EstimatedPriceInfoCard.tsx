    ...
    <View style={styles.container}>
      {visibleOnlyForViewShotSharing ?
        <View style={styles.logoContainer}>
          {/* <Image source={PRIMARY_Logo} style={styles.image} /> */}
        </View>
        : false
      }
        ...
        return (
          <View style={[styles.infoContainer, { paddingVertical: 10 }]}>
            <View style={styles.descriptionInfoContainer}>
              ...
              <Text style={styles.productTextStyles}>{item.productVariant}</Text>
            ...
            <View style={styles.subTotalInfoContainer}>
              <Text style={styles.infoTextStyles}>₹ {item.subTotal}</Text>
            </View>
          </View>
        );
      })}
      <Divider style={styles.divider} bold={true} />
      {/* TODO:- commented the code temporary as asked by atul */}
      {/* <View style={styles.lightGreyTextRow}>
        <Text style={styles.lightGreyText}>Subtotal</Text>
        <Text style={styles.lightGreySubText}>₹ {subTotal}</Text>
      </View>
      <View style={styles.lightGreyTextRow}>
        <Text style={styles.lightGreyText}>Discount</Text>
        <Text style={styles.lightGreySubText}>₹ {totalDiscount}</Text>
      </View> */}
      <Divider style={styles.divider} bold={true} />
      <View style={[styles.lightGreyTextRow]}>
